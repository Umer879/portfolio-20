      ...
      <div>
        <div className="bg-[#1f3435] p-3 rounded-lg profile text-center shadow-lg w-[310px]">
          ...
          <a
            href="/Umer Gull.pdf"
            download
            className="mt-5 my-2 px-6 py-1 bg-[#FFAE00] text-black font-bold rounded-full button hover:text-white transition inline-block"
          >
            <div className='flex py-2 justify-center text-center'>
              DOWNLOAD CV <span className='ms-2 mt-1'><FaDownload /></span>
            </div>
          </a>
